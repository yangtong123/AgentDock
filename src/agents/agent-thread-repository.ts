...
export interface AgentThreadRepository { create(thread:AgentThread):AgentThread; findById(id:string):AgentThread|undefined; listForTask(taskId:string):AgentThread[]; }
