...
export interface CreateProjectInput { name: string; repoPath: string; baseBranch?: string; worktreeRoot: string; status?: ProjectStatus; maxConcurrentTasks?: number; defaultWorkflowPreset?: string | null; verifyCommand?: string[] | null; permissionProfile?: string | null; }
